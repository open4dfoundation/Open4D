...
target_mesh_dir = os.path.join(data_base_path, "meshes")
target_centers_dir = os.path.join(data_base_path, "centers")

for target_dir in [target_mesh_dir, target_centers_dir]:
...
for obj_file in selected_obj_files:
    ...
    target_path = os.path.join(target_mesh_dir, obj_file)
    shutil.copy(file_path, target_path)

for xyz_file in selected_xyz_files:
    file_path = os.path.join(centers_dir, xyz_file)
    target_path = os.path.join(target_centers_dir, xyz_file)
    shutil.copy(file_path, target_path)
...
print("Find centers transformations here: ", data_base_path)