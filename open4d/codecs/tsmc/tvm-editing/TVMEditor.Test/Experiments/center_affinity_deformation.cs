...
namespace TVMEditor.Test.Experiments
{
    ...
    {
        public static void Run(string dataset, string inputDir, string outputDir, int firstIndex, int lastIndex, string mode)
        {
            ...
            if (mode == "1")
            {
                ...
                {
                    Console.WriteLine($"Dealing with index={index} for {dataset}");
            ...
            {
                Console.WriteLine($"Reference mesh deformation..., dataset: {dataset}");
                ...
                for (int index = firstIndex; index < lastIndex+1; index++)
                {
                    Console.WriteLine($"Deform Reference mesh to {dataset} {index}...");
