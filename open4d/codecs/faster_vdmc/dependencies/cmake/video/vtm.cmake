if ( USE_VTM_VIDEO_CODEC )
  ...
  if (MSVC)
    add_definitions("/W3 /D_CRT_SECURE_NO_WARNINGS /nologo /std:c++17")
  endif()
  ...
  if( NOT EXISTS "${VTM_DIR}/PATCHED" )
    ...
    set( VTM_PATCH ${CMAKE_SOURCE_DIR}/dependencies/patches/vtm/adaptions_for_vtm_21.2.patch )
