...
def get_config():
    ...
    parser.add_argument("--quant_mode", type=str, default="on", choices=["off", "on"])
    parser.add_argument("--qat_start_epoch", type=int, default=1)

    parser.add_argument('--l1_reg',type=float,default=0)
    parser.add_argument("--autocodec_path", type=str, default=None)
    ...
    parser.add_argument("--sign_weight", type=float, default=3.0)
    parser.add_argument("--sign_band", type=float, default=0.05)
    parser.add_argument("--sign_margin", type=float, default=0.01)
    parser.add_argument("--zero_bias_weight", type=float, default=1.0)
    parser.add_argument("--zero_bias_band", type=float, default=0.05)
